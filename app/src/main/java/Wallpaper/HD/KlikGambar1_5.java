...
public class KlikGambar1_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klik_gambar1_5);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBitmapSize();
                wallpaperManager = WallpaperManager.getInstance(KlikGambar1_5.this);
                Toast.makeText(KlikGambar1_5.this, "Wallpaper Selected", Toast.LENGTH_LONG).show();
                try{
