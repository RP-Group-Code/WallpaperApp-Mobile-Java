...
public class KlikGambar1_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klik_gambar1_4);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBitmapSize();
                wallpaperManager = WallpaperManager.getInstance(KlikGambar1_4.this);
                Toast.makeText(KlikGambar1_4.this, "Wallpaper Selected", Toast.LENGTH_LONG).show();
                try{
