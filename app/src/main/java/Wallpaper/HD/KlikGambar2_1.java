...
public class KlikGambar2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klik_gambar2_1);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBitmapSize();
                wallpaperManager = WallpaperManager.getInstance(KlikGambar2_1.this);
                try{
                    wallpaperManager.setBitmap(bitmap2);
                    wallpaperManager.suggestDesiredDimensions(width,height);
                    Toast.makeText(KlikGambar2_1.this, "Wallpaper Selected", Toast.LENGTH_LONG).show();
