...
public class KlikGambar1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klik_gambar1);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBitmapSize();
                wallpaperManager = WallpaperManager.getInstance(KlikGambar1.this);
                Toast.makeText(KlikGambar1.this, "Wallpaper Selected", Toast.LENGTH_LONG).show();
                try{
